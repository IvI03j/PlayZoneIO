    ...
    <div className="min-h-screen bg-[#050505] grid-pattern flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-500 uppercase tracking-wider text-sm">Inicia sesion para tu biblioteca</p>
        </div>
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-[#050505] text-zinc-600 font-medium">No tienes cuenta?</span>
          </div>
        </div>
        ...
        <div className="mt-8 p-4 bg-green-500/5 border border-green-500/20 rounded-xl text-center">
          <p className="text-zinc-500 text-sm">
            Puedes jugar sin registrarte. Unicam necesitas cuenta para biblioteca y logros.
          </p>
        </div>
      </div>
    </div>
